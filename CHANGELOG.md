...
## Fork Changes (naoki-sakamoto/claude-code-action@beta)
...
- **Updated Base Action**: Uses `naoki-sakamoto/claude-code-base-action@beta` which includes OAuth credential handling
